...
h=figure('Units','centimeters','Position',[2 2 30 N*5+5]); 
...
ylab=annotation('textbox',[lm*0.05 1-tp-(hi+vs)*(ne-1)-hi/15+0.005 lm*0.75 hi/5],'String',[datestr(t_in(ne),'mmm-dd'),add{ne}],'Interpreter','none','LineStyle','none','FontSize',f_size);
...
print(gcf,'-djpeg','-r500','Fig2_allin1')
